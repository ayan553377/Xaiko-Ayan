module.exports = {
  ...
  onStart: async function ({ api, event, userData, args }) {
    ...
    if(!mention) return api.sendMessage("please tag a 1 parson-!!😺", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = []; 
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
setTimeout(() => {a({body: "তোর মার ভোদায় পাব্লিক টয়লেট 🥵তর মায়ের ভুদাতে পোকা 🥵তর বাপের হোল তর বউয়ের ভোদাতেদিমু " + " " + name, mentions: arraytag})}, 3000);
...
setTimeout(() => {a({body: "AYAN THE GREAT EXIT!!😾🥀🤣" + " " + name, mentions: arraytag})} , 84000);
  }
};
